...
def arc_calculate(a1,n1, a2,n2):
    ...
    dn = 7 # Range of n to consider (n0-dn:n0+dn)
    dl = 7 # Range of l values
    ...
    separations_file = f"{output_dir}arc_calculate("Cs",eval(sys.argv[1]),"Rb",eval(sys.argv[2]))
/{n1}{n2}_r.csv"
